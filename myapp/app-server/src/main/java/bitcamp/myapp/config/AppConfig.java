...
public class AppConfig {
  ...
  @Bean
  public UserService createUserService(UserDao userDao, SqlSessionFactory sqlSessionFactory)
      throws Exception {
    return new DefaultUserService(userDao, sqlSessionFactory);
  }

  @Bean
  public BoardService createBoardService(BoardDao boardDao, SqlSessionFactory sqlSessionFactory)
      throws Exception {
    return new DefaultBoardService(boardDao, sqlSessionFactory);
  }

  @Bean
  public ProjectService createProjectService(ProjectDao projectDao,
