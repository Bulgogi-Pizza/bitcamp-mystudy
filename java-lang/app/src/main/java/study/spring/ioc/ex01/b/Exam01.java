// 스프링 IoC 컨테이너 사용
package study.spring.ioc.ex01.b;
...
public class Exam01 {
  public static void main(String[] args) {
    ...
    ApplicationContext iocContainer = new FileSystemXmlApplicationContext(
        "file:///Users/eomjinyoung/git/eomcs-java/eomcs-java-lang/app/src/main/java/study/spring/ioc/ex01/b/application-context.xml");
