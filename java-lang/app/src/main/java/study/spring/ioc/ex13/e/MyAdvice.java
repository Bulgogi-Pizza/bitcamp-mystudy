...
package study.spring.ioc.ex13.e;
...
// 
// XML 설정 예:
//      <bean id="myAdvice" class="study.spring.ioc.ex13.e.MyAdvice"/>
//
@Component
...
public class MyAdvice {
  ...
  // XML 설정 예:
  //    <aop:before
  //        pointcut="execution(* study.spring.ioc.ex13.e.X.*(..)) and args(a,b)"
  //        method="doBefore"/>
  //
  @Before("execution(* study.spring.ioc.ex13.e.X.*(..)) and args(x,y)")
  ...
  //XML 설정 예:
  //    <aop:after
  //        pointcut="execution(* study.spring.ioc.ex13.e.X.*(..))"
  //        method="doAfter"/>
  //
  @After("execution(* study.spring.ioc.ex13.e.X.*(..))")
  public void doAfter() {
